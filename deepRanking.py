...
class DataGenerator(object):
    ...
    def get_train_generator(self, batch_size):
        return self.idg.flow_from_directory("modified_data",
    ...
    def get_test_generator(self, batch_size):
        return self.idg.flow_from_directory("/content/gdrive/MyDrive/deep_ranking/modified_data",
                                            batch_size=batch_size,
                                            target_size=self.target_size, shuffle=False,
                                            triplet_path  ="output/triplets.txt"
                                        )
...
model_path = "model/deepranking.h5"

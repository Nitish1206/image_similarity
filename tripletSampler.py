...
if __name__ == '__main__':
    ...
    #     quit()
    input_directory="modified_data/"
    output_directory="output"

    if args.num_pos_images == None:
    ...
    triplet_sampler(directory_path=input_directory, output_path=output_directory, num_neg_images=args.num_neg_images, num_pos_images=args.num_pos_images)
